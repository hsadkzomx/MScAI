...
def draw(prog, xsize, ysize):
    """Given a "program" *prog*, run that program by "moving around" and
    tracking what happens. Visualise the cells that have been visited
    ...
    # We have already visited the "current" junction.
    g[x][y] = 1
    ...
    # Notice we print the result but don't return anything
